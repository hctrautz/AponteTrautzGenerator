...
//				}
			...
			case WALK_FORWARD:
				...
				} else if(block(levelSceneFromBitmap)){
					facing_left = true;
					state = STATE.WALK_BACKWARD;
				}
				break;
			...
			case JUMP:
				...
				currentPos = model.getMarioScreenTilePos();
...
//				if(block(levelSceneFromBitmap) && stuck(levelSceneFromBitmap, model.getMarioScreenTilePos()[1])){
//					facing_left = true;
//					state = STATE.WALK_BACKWARD;
//				}
